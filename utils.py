...
def padding_sentence_sequences(index_sequences, scores, gaze, max_sentnum, max_sentlen, post_padding=True):
    ...
    Y_G = np.empty([5, len(index_sequences), max_sentnum, max_sentlen], dtype=np.float32)
...
def padding_sentence_sequences_my(index_sequences, scores, gaze, max_sentnum, max_sentlen, post_padding=True):
